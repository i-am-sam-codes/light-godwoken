...
For more infomation about withdraws, please refer to Godwoken docs:
...
1. If you are a new user of Godwoken network, you may encounter some unknown errors on Godwoken Bridge page, this is because that your account is not registered on Godwoken network. Just deposit some CKB to Godwoken network, the problems will be gone.
